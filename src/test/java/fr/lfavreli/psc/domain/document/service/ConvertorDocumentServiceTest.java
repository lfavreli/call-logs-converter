...
class ConvertorDocumentServiceTest {

    @InjectMocks
    private ConvertorDocumentService convertorDocumentService;
    ...
    public void testExecute() {
        ...
        // WHEN
        Mono<ServerResponse> monoResponse = convertorDocumentService.execute(filePart);
